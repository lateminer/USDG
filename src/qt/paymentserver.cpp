...
const char* BIP71_MIMETYPE_PAYMENT = "application/usdg-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/usdg-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/usdg-paymentrequest";
...
//
// OSX-specific way of handling usdg: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in usdg: URIs
