...
const char * const BITCOIN_PID_FILENAME = "usdg.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\usdg
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\usdg
    // Mac: ~/Library/Application Support/usdg
    // Unix: ~/.usdg
#ifdef WIN32
    // Windows
