...
unlocked to sign the USDG-Qt.app bundle.
...
allowing somebody to distribute a USDG-Qt.app or usdg-qt-setup.exe with a valid
...
that the usdg-qt.exe file inside the installer had not been tampered with.
